    ...
    <div className="modal-overlay" onClick={onCerrar}>
      <div className="modal-contenido" onClick={e => e.stopPropagation()} style={{ maxHeight: '85vh', overflowY: 'auto' }}>
        ...
        <div className="modal-header">
          <p className="guia-intro">Configuración</p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '20px' }}>
          ...
          <p className="detalle-seccion-titulo">Apariencia</p>
          ...
          <div className="config-fila" onClick={onToggleDark}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <p className="reto-titulo">{darkMode ? 'Modo claro' : 'Modo oscuro'}</p>
            </div>
          ...
          <div className="config-fila" onClick={onToggleIdioma}>
            ...
            <span style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>
              {idioma === 'es' ? 'Cambiar a English' : 'Cambiar a Español'}
            </span>
          </div>

          <p className="detalle-seccion-titulo" style={{ marginTop: '12px' }}>Notificaciones</p>

          <div className="config-fila" onClick={handleNotificaciones}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <i className="ti ti-bell" style={{ fontSize: '20px', color: 'var(--accent)' }}></i>
              <p className="reto-titulo">Recordatorio diario</p>
            </div>
          ...
          {notificaciones && (
            <div className="config-fila">
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <p className="reto-titulo">Hora del recordatorio</p>
              </div>
              <input
                type="time"
                ...
                style={{ border: 'none', background: 'none', color: 'var(--text-primary)', fontSize: '14px', fontFamily: 'Nunito, sans-serif' }}
              />
            </div>
          )}
          ...
          {mostrarInstrucciones && (
            <div style={{
              background: 'var(--bg-secondary)', border: '0.5px solid var(--accent)',
              borderRadius: '12px', padding: '16px', marginTop: '4px'
            }}>
              <p className="reto-titulo" style={{ marginBottom: '10px' }}>Cómo activar notificaciones</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <p className="guia-texto" style={{ fontSize: '13px' }}>1. Abre <strong>Ajustes</strong> en tu iPhone</p>
                <p className="guia-texto" style={{ fontSize: '13px' }}>2. Busca <strong>Hoylo</strong> en la lista de apps</p>
                <p className="guia-texto" style={{ fontSize: '13px' }}>3. Pulsa <strong>Notificaciones</strong></p>
                <p className="guia-texto" style={{ fontSize: '13px' }}>4. Activa <strong>Permitir notificaciones</strong></p>
              </div>
              <button
          ...
          <p className="detalle-seccion-titulo" style={{ marginTop: '12px' }}>Privacidad</p>

          <div className="config-fila" onClick={togglePerfilPublico}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <i className="ti ti-lock" style={{ fontSize: '20px', color: 'var(--accent)' }}></i>
              <div>
                <p className="reto-titulo">Perfil público</p>
                <p style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>
                  {perfilPublico ? 'Otros pueden encontrarte por username' : 'Solo tus amigos pueden verte'}
                </p>
              </div>
            </div>
          ...
          <p className="detalle-seccion-titulo" style={{ marginTop: '12px' }}>Cuenta</p>
          ...
          <div className="config-fila" onClick={() => supabase.auth.signOut()}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <p className="reto-titulo">Cerrar sesión</p>
            </div>
          ...
          <div className="config-fila" onClick={() => setConfirmEliminar(true)}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <p className="reto-titulo" style={{ color: '#E24B4A' }}>Eliminar cuenta</p>
            </div>
          ...
          {confirmEliminar && (
            <div style={{
              background: 'var(--bg-secondary)', border: '0.5px solid #E24B4A',
              borderRadius: '12px', padding: '14px', marginTop: '4px'
            }}>
              <p className="guia-texto" style={{ fontSize: '13px', marginBottom: '10px' }}>
                ¿Seguro? Esta acción no se puede deshacer.
              </p>
              <div style={{ display: 'flex', gap: '8px' }}>
                <button
                  className="btn-principal"
                  style={{ background: 'var(--bg-card)', color: 'var(--text-primary)', border: '0.5px solid var(--border)' }}
          ...
          <p className="detalle-seccion-titulo" style={{ marginTop: '12px' }}>Sobre la app</p>

          <div className="config-fila">
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <i className="ti ti-info-circle" style={{ fontSize: '20px', color: 'var(--accent)' }}></i>
              <p className="reto-titulo">Versión</p>
            </div>
